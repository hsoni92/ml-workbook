...
- Build first-principles understanding of `CloudWatch Metrics`.
...
- `CloudWatch`: AWS observability service for metrics, logs, alarms, and dashboards.
...
- Key technologies here: `CloudWatch`.
...
- Recall precise definitions for: CloudWatch.
