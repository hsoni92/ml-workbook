...
- Build first-principles understanding of `What is a Container Registry`.
...
- `ECR`: Amazon Elastic Container Registry, a managed private registry for storing container images.
...
- Key technologies here: `Container`, `ECR`.
...
- Recall precise definitions for: Container, ECR.
