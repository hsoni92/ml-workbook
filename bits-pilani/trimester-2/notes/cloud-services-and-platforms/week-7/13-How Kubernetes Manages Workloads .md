...
- Build first-principles understanding of `How Kubernetes Manages Workloads`.
...
- `Kubernetes`: a container orchestration platform that schedules, scales, and heals workloads declaratively.
...
- Key technologies here: `Kubernetes`.
...
- Recall precise definitions for: Kubernetes.
