...
- Build first-principles understanding of `CIDR & Ip Addressing`.
...
- `CIDR`: a notation for expressing IP ranges compactly, such as 10.0.0.0/16, where the suffix controls network size.

## Intuition Before Mechanics

- CIDR expresses network capacity planning in a compact prefix format.
- Subnetting is a security and operability tool, not just an addressing exercise.
- Good IP planning prevents expensive renumbering during scale-out or peering.
- Key technologies here: `CIDR`.
...
- Recall precise definitions for: CIDR.
