...
- Build first-principles understanding of `VPC Routing Essentials`.
...
- `Route Table`: a set of forwarding rules that determines where traffic from a subnet is sent.
...
- Key technologies here: `VPC`, `Route Table`.
...
- Recall precise definitions for: VPC, Route Table.
