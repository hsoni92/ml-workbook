...
- **Effect:** Multiply many numbers &lt; 1 → **exponential** shrinkage. Example: $(0.5)^{20} \approx 10^{-6} \approx 0$. Early layers get **almost no** gradient → they **stop learning**.
...
- **Effect:** Each layer multiplies the gradient by something &gt; 1; after 20–30 layers this becomes huge. Example: $(1.5)^{20} \approx 3300$. Updates become **enormous** → **unstable** or **divergent** training.
