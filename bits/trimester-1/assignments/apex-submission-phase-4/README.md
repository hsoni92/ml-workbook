...
This project aims to predict house sale prices using machine learning regression techniques. Accurate house price prediction helps real estate agents and buyers make informed decisions, enables financial institutions to assess property values for loans, and helps investors identify undervalued properties.
...
2. **Kaggle API**: Need a Kaggle account and API credentials
...
4. **Open and run the notebooks:**
   ...
   - **Phase 4 Notebook:** `protected_apex_project_phase4_deliverable.ipynb` - Contains complete pipeline:
   ...
   The notebooks will download the dataset using the Kaggle API when executed.

5. **Run all cells:** Execute all cells sequentially (Cell → Run All) or run cells individually.

### Note

The notebooks will automatically download the dataset from Kaggle using the API. Make sure your Kaggle credentials are set up before running the data download cells.
